...
#    ranks = np.array([8,16,32,48,64])
    ...
    for rank in ranks:
        for seed in seeds:
            file = dir + "dat_cp_errors_L16_g1.0000000000_D8_rank{}_seed{}".format(rank, seed)
...
#    plt.legend(ncols=1,columnspacing=1,handletextpad=0,fontsize=24,bbox_to_anchor=(1,1.03))
    plt.legend(ncols=4,columnspacing=1,handletextpad=0,fontsize=22,loc="lower center")
#    plt.legend(ncols=3,columnspacing=1,handletextpad=0,fontsize=22,loc="lower center")
