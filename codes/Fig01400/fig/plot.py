...
#    Ls = np.array([16,18,20,22,24,28,32,40,48,64,80])
    ...
    for i,L in enumerate(Ls):
        dir = "../mps_rbm/L"+"{}".format(L)+"g0.5_D"+"{}".format(Ds[i])+"_rank"+"{}".format(ranks[i])+"_periodic_1e4plus1e5samples/"
        file = "dat_vmc_enes_ave_err_L"+"{}".format(L)+"_g0.5000000000_D"+"{}".format(Ds[i])+"_rank"+"{}".format(ranks[i])+"_seed12345"
